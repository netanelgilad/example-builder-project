...
import { cartStore } from "../../ecom/generated/cartStore";

export function ProductPage() {
    const { products: { queryProducts }, currentCart: { addToCurrentCart }, cartStore: { reloadCart } } = useWixModules({ products, currentCart, cartStore });
